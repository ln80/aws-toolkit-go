module github.com/ln80/aws-toolkit-go
...
require (
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/attributevalue v1.15.11 // indirect
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/expression v1.7.46 // indirect
